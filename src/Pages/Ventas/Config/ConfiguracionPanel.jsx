  ...
  return (
    <div className="max-w-4xl mx-auto px-2 sm:px-6 py-8 min-h-screen flex flex-col">
      ...
      <div className="mb-10 flex items-center justify-center gap-4 text-center">
        <span className="inline-flex items-center justify-center bg-emerald-100 dark:bg-emerald-900 rounded-full p-3 shadow-lg">
          <FaCog className="text-emerald-600 dark:text-emerald-400 text-4xl animate-spin-slow" />
        </span>
        <div>
          <h1 className="titulo uppercase text-4xl sm:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-cyan-500 to-violet-500 animate-gradient-move inline-block drop-shadow-xl select-none">
            Configuración
          </h1>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {/* Card: Medios de Pago */}
        <div
          className="relative group bg-white/80 dark:bg-zinc-900/90 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xl p-8 flex flex-col items-center text-center
            backdrop-blur-sm transition-transform hover:scale-[1.025] hover:shadow-2xl"
        >
